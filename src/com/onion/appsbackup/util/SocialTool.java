...
public class SocialTool {
    ...
    public static boolean joinQQGroup(Context context) {
        ...
        try {
            ...
            // 未安装手Q或安装的版本不支持
            Toast.makeText(context, "未安装QQ或安装的版本不支持", Toast.LENGTH_SHORT).show();
            return false;
        }
    }
    ...
    public static void shareApp(Context context, String title, String content) {
        ...
        try {
            ...
            Toast.makeText(context, "未找到分享工具", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public static void downloadMusic(Context context, String url) {
        ...
        try {
            ...
            Toast.makeText(context, "未找到下载工具", Toast.LENGTH_SHORT).show();
        }
    }
}
